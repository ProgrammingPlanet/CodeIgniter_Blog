...
<head> 
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/nunito-font.css') ?>">
  <style type="text/css">
    body {
...
<body class="">
  ...
  <div class="container bg-dark rounded"><br>
    <div class="row">
      ...
      <?php if(sizeof($articals)!=0): ?>
        ...
        <h1 class="my-4 text-white text-center">Latest Articals By Codeigniter Blog</h1>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; <a href="https://www.facebook.com/CodingPlanet1">Programming Planet</a> 2019</p>
    </div>
    <!-- /.container -->
  </footer>
